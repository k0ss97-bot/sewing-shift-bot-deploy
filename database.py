...
PRODUCT_OPTIONS = {
    ...
    "Брюки-ползунки": {
        "colors": ["бежевый", "голубой", "капучино", "кофейный", "светло-серый", "темно - синий", "черный", "Коричневый", "серый", "темно зеленый", "Карамель", "брауни", "Розовый", "Желтый", "синий", "темно - зеленый", "темно синий", "светло - сервый", "Бежевый", "Голубой", "Капучино"],
