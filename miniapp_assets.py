...
<body>
  ...
  <script>
    ...
    document.addEventListener("click", (event) => {
      ...
      if (wmsShipmentAction && wmsShipmentAction.dataset.wmsShipmentAction === "back") {
